...
<div class="header-box">
    <h1>&#128202; Boletin de Indicadores &mdash; Colombia 2017&ndash;2023</h1>
    <p>Seminario de Desigualdad, Exclusion y Pobreza &nbsp;&middot;&nbsp; Nivel Nacional &nbsp;&middot;&nbsp; Fuente: DANE</p>
</div>
""", unsafe_allow_html=True)
...
kpi(k1, "Desempleo maximo",       "17.6", "%", "2021 - post-COVID", C_DES)
kpi(k2, "Pobreza monetaria max.", "43.1", "%", "2020 - COVID-19",   C_POB)
kpi(k3, "Pobreza extrema max.",   "17.3", "%", "2020 - COVID-19",   C_EXT)
...
with tab1:
    ...
    <strong>Analisis:</strong> La Tasa de Desocupacion (TD) mostro una tendencia al alza moderada
    entre 2017 (12,0%) y 2019 (13,1%), antes del choque externo. En <strong>2020-2021</strong>
    el desempleo alcanzo su pico de <strong>17,6%</strong>, producto del cierre de actividades durante
    la pandemia de COVID-19. La recuperacion fue gradual: 14,6% en 2022 y 13,7% en 2023, sin retornar
    a niveles pre-pandemia, evidenciando <strong>cicatrices estructurales</strong> en sectores de
    turismo, comercio e informalidad. La caida en la TGP (2020-2021) refleja el efecto del
    trabajador desalentado: personas que dejaron de buscar empleo activamente.
    </div>
    <div class="note-box">
    <strong>Nota metodologica:</strong> La TD excluye trabajadores desalentados y subempleados,
...
with tab2:
    ...
    st.markdown("""
    <div class="analysis-box">
    <strong>Analisis:</strong> La pobreza monetaria nacional se mantuvo relativamente estable en
    torno a 35-36% entre 2017 y 2019, antes de dar un salto dramatico a <strong>43,1%</strong>
    en 2020, equivalente a aproximadamente <strong>21 millones de personas</strong> por debajo
    de la linea de pobreza. Este aumento esta vinculado a la perdida de ingresos laborales durante
    la pandemia, que afecto desproporcionadamente a trabajadores informales (~47% de la fuerza
    laboral). La pobreza extrema paso de 12,0% (2019) a <strong>17,3%</strong> (2020).
    La recuperacion parcial en 2021-2023 es atribuible a la reactivacion economica y programas
    de transferencias como Ingreso Solidario.
    </div>
    """, unsafe_allow_html=True)
...
with tab3:
    ...
    fig_cmp.add_trace(go.Scatter(
        x=ANOS, y=tdd, name="Desempleo TD (%)",
        mode="lines+markers",
        line=dict(color=C_DES, width=3),
    ...
    fig_cmp.update_yaxes(title_text="Tasa de Desocupacion (%)", secondary_y=False,
    ...
    st.caption("Rojo = maximo del periodo | Verde = minimo del periodo")

    st.markdown("""
    <div class="analysis-box">
    <strong>Sintesis:</strong> Los dos indicadores muestran una correlacion positiva clara:
    cuando el desempleo sube, la pobreza monetaria tambien lo hace, con 2020 como el año de
    mayor deterioro simultaneo. El mercado laboral es el canal de transmision mas directo entre
    la actividad economica y el bienestar de los hogares. La recuperacion post-pandemia fue
    mas rapida en terminos de PIB que en terminos de empleo y pobreza, evidenciando una
    <strong>recuperacion asimetrica</strong> que beneficio mas a los hogares de mayores ingresos.
    </div>
    """, unsafe_allow_html=True)
...
• DANE (2023). Gran Encuesta Integrada de Hogares (GEIH) - Series historicas. Bogota: DANE.<br>
• DANE (2023). Pobreza monetaria y desigualdad - Boletines tecnicos 2017-2023. Bogota: DANE.<br>
<span style="color:#7FB3D3; font-size:0.78rem;">Seminario de Desigualdad, Exclusion y Pobreza · Indicadores Colombia 2017-2023</span>
</div>
""", unsafe_allow_html=True)